...
// Create Sei testnet chain configuration
const seiTestnetChain = {
  id: 1328,
  name: "Sei Testnet",
  network: "sei-testnet",
...
async function seiTestnetClient() {
  console.log("🚀 Sei Testnet x402 Client\n");

  // Create account and clients
  const account = privateKeyToAccount(PRIVATE_KEY);
  const publicClient = createPublicClient({
    chain: seiTestnetChain,
    transport: http(),
  });
...
// Run the client
seiTestnetClient().catch(console.error);

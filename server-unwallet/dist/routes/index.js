...
router.get('/', (req, res) => {
    res.json({
        ...
        exampleRequest: {
            ...
            body: {
                chainId: chains_1.CHAIN_IDS.SEI_TESTNET,
        ...
        safeAddressPrediction: {
            ...
            functionality: {
                ...
                chainSupport: `Supports Sei Testnet (chainId: ${chains_1.CHAIN_IDS.SEI_TESTNET}), Base Sepolia (chainId: ${chains_1.CHAIN_IDS.BASE_SEPOLIA}), and Arbitrum Sepolia (chainId: ${chains_1.CHAIN_IDS.ARBITRUM_SEPOLIA})`,
